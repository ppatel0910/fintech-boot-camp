...
* The slides for this lesson can be viewed on Google Drive here: [5.1 Slides](https://docs.google.com/presentation/d/1qpX6GyFREMyYbh14Mi-Obs7d3Rnuct29atnraYHaJQg/edit?usp=sharing).
...
Before initiating the demo, ask if there are any students who do not have [Postman](https://www.postman.com/downloads) installed. Instruct TAs to help these students install Postman. Postman will be needed for the first few modules of the lesson.
